 ...
 */
public class SEControlProtocolTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.infn.cnaf.forge.glueschema.spec.v12.r2.SEControlProtocolType
{
    private static final long serialVersionUID = 1L;
    
    public SEControlProtocolTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public it.infn.cnaf.forge.glueschema.spec.v12.r2.SEControlProtocolOpenEnum xgetType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.infn.cnaf.forge.glueschema.spec.v12.r2.SEControlProtocolOpenEnum target = null;
            target = (it.infn.cnaf.forge.glueschema.spec.v12.r2.SEControlProtocolOpenEnum)get_store().find_element_user(TYPE$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetType(it.infn.cnaf.forge.glueschema.spec.v12.r2.SEControlProtocolOpenEnum type)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (it.infn.cnaf.forge.glueschema.spec.v12.r2.SEControlProtocolOpenEnum)get_store().add_element_user(TYPE$2);
            }
            target.set(type);
        }
    }
